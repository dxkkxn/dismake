...
type PingPongClient interface {
	// Sends a greeting
	Pong(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error)
}
...
func (c *pingPongClient) Pong(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error) {
	out := new(PongResponse)
	err := c.cc.Invoke(ctx, "/helloworld.PingPong/Pong", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingPongServer interface {
	// Sends a greeting
	Pong(context.Context, *PingRequest) (*PongResponse, error)
...
func (UnimplementedPingPongServer) Pong(context.Context, *PingRequest) (*PongResponse, error) {
...
func _PingPong_Pong_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.PingPong/Pong",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingPongServer).Pong(ctx, req.(*PingRequest))
	}
...
var PingPong_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "helloworld.PingPong",
